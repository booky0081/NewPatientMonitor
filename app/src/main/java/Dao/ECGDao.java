...
public interface ECGDao {
    ...
    @Query("SELECT  ECG.id as id, DeviceModel.id as meta_id,file_id, datetime(DeviceModel.created_date / 1000 , 'unixepoch') as  created_date, datetime(DeviceModel.stop_date / 1000 , 'unixepoch') as stop_date,DeviceModel.device_name, " +
